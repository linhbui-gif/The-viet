    ...
    @elseif($item->id == 27)
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="">Name</label>
                    <input value="{{ @$content['services_page']['name'] }}" name="content[services_page][name]" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Description</label>
                    <input value="{{ @$content['services_page']['description'] }}" name="content[services_page][description]" type="text" class="form-control">
                </div>
            </div>
        </div>
    @elseif($item->id == 28)
